...
const VALUES = [
  ...
  { icon: Globe2, title: 'Four services, one place', description: 'Flights, hotels, tour packages and cabs — search and compare without switching between apps.', color: 'var(--color-max-pink)' },
...
const MILESTONES = [
  ...
  { year: '2015', icon: Plane, title: 'International packages added', description: 'Grew into full holiday packages across the Gulf, Southeast Asia and Europe, with in-house itineraries instead of reseller brochures.', color: 'var(--color-max-pink)' },
  ...
  return (
    ...
    >
      ...
      <div className="p-5 rounded-2xl bg-white max-border max-shadow-sm flex items-start gap-3 rotate-1">
        <div className="w-10 h-10 rounded-xl max-border flex items-center justify-center shrink-0" style={{ backgroundColor: 'var(--color-max-green)' }}>
