    ...
    <div className="bg-white rounded-2xl max-border max-shadow-sm p-5 sm:p-6 space-y-5">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b-2 pb-3" style={{ borderColor: 'var(--color-ink)' }}>
        ...
        {flight.priceTrend.isLowest7Days ? (
          ...
          <span className="px-2.5 py-1 rounded-full bg-slate-50 text-slate-500 text-xs font-semibold max-border">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
        ...
        {flight.stops > 0 && flight.stopDetails && (
          <div className="md:col-span-12 text-xs text-slate-600 bg-slate-50 rounded-lg px-3 py-2 max-border">
      ...
      <div className="pt-3 border-t-2 flex flex-wrap items-center justify-between gap-3" style={{ borderColor: 'var(--color-ink)' }}>
