    ...
    >
      <div className="bg-cream w-full max-w-5xl rounded-2xl overflow-hidden flex flex-col max-h-[90vh] soft-border soft-shadow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 overflow-y-auto flex-1 divide-y lg:divide-y-0 lg:divide-x-[3px] divide-slate-900">
          ...
          <div className="lg:col-span-5 p-6 bg-cream flex flex-col justify-between space-y-6">
            <form onSubmit={handleCompleteBooking} className="space-y-5">
              <div>
                <h4 className="text-sm font-black text-slate-900 flex items-center gap-1.5">
                  <User className="w-3.5 h-3.5" style={{ color: 'var(--color-ticket-orange)' }} aria-hidden="true" />
                  Passenger details
                </h4>
