      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {packages.map((pkg, i) => (
          <Link
            ...
            className={`group bg-cream rounded-2xl hover:-translate-y-0.5 transition-all overflow-hidden flex flex-col max-border max-shadow-sm ${i % 3 === 1 ? 'sm:-translate-y-2' : ''}`}
          >
