...
import { Plane, Globe, Menu, X, Search, Radio, TrendingUp, Ticket, Building2 } from 'lucide-react';
...
interface HeaderProps {
  ...
  activeTab: 'book' | 'hotels' | 'radar' | 'price' | 'bookings';
  onTabChange: (tab: 'book' | 'hotels' | 'radar' | 'price' | 'bookings') => void;
}

const TABS: { id: 'book' | 'hotels' | 'radar' | 'price' | 'bookings'; label: string; icon: React.ElementType }[] = [
